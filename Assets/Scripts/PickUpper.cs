...
public class PickUpper : MonoBehaviour
{
    ...
    private KeyCode pickUpButtonController = KeyCode.JoystickButton0;//3; //KeyCode.JoystickButton0; 
    ...
    private KeyCode moveForwardButtonController = KeyCode.JoystickButton7;//10; //KeyCode.JoystickButton7;
